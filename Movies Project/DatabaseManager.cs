...
namespace Movies_Project
{
    ...
    {
        public string str = "Data Source=LAPTOP-RAKIOMBV\\SQLEXPRESS;Initial Catalog=Movies_Project;Integrated Security=True";

        SqlCommand SqlStr = new SqlCommand();
        SqlDataReader SqlReader;
        String SqlStmt;
        SqlConnection SqlConn = new SqlConnection("Data Source=LAPTOP-RAKIOMBV\\SQLEXPRESS;Initial Catalog=Movies_Project;Integrated Security=True");
